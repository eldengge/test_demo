...
public class D2Visibility {
	private static final String urlHead = "http://www.nmc.cn/publish/sea/seaplatform1";
...
//			System.out.println("图片地址不存在,稍后下载.....");
	...
	private File getFilePath(String imgUrl){
		int index = imgUrl.lastIndexOf("_");
		String urlTimeStr = imgUrl.substring(index+1, index+11);
		String fname = getDateString(urlTimeStr, BEFOR_TIME, PATTERN_FILENAME) +".vis";
		String dataHome = DATA_HOME;
		String filePath = dataHome + "visibility" + File.separator + getDateString(urlTimeStr, BEFOR_TIME, PATTERN_DIR) + File.separator + fname;
